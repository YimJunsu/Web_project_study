...
public interface StudentMapper {
     ...
     */
    // (2) 1=1 : SQL 에서 강제로 true 가 필요할때 사용하는 방법(SQL 에서는 true값이 존재하지 않음)
    //  즉) 다음 조건이 있을수도 있고 없을수도 있을 때
    @Select("""
            <script>
    ...
    // minKor 가 없고 minMath 가 없을때 : select * from student where 1 = 1
    // minKor 가 90 이고 minMath 가 70 일때 : select * from student 1 = 1 and kor >= 90 and math >= 70
